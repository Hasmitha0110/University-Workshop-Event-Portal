    ...
    return (
        <div className="max-w-lg mx-auto px-1 py-15">
                ...
                <form onSubmit={handleSubmit} className="bg-ink/60 border border-white/10 rounded-xl flex flex-col p-6 space-y-4">
                    ...
                    <input type="text" name="name" placeholder="Jhony Sins" className="w-full bg-black/40 border border-white/10 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gold" onChange={handleChange} required/>
                    </div>

                    <div className="space-y-1">
                        <label className="text-sm text-white/80">Email</label>
                    <input type="email" name="email" placeholder="jhony@example.com" className="w-full bg-black/40 border border-white/10 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gold" onChange={handleChange} required/>
                    </div>
